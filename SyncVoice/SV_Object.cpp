...
//==================================================================================================
#pragma mark -
#pragma mark SV_Object
//==================================================================================================

#pragma mark Construction/Destruction

SV_Object::SV_Object(AudioObjectID inObjectID, AudioClassID inClassID, AudioClassID inBaseClassID, AudioObjectID inOwnerObjectID)
:
...
void	SV_Object::Activate()
{
	mIsActive = true;
}

void	SV_Object::Deactivate()
{
	mIsActive = false;
}
...
bool	SV_Object::HasProperty(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress) const
{
...
bool	SV_Object::IsPropertySettable(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress) const
{
	#pragma unused(inObjectID, inClientPID)
...
UInt32	SV_Object::GetPropertyDataSize(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress, UInt32 inQualifierDataSize, const void* inQualifierData) const
{
...
void	SV_Object::GetPropertyData(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32 inDataSize, UInt32& outDataSize, void* outData) const
{
	#pragma unused(inObjectID, inClientPID, inQualifierDataSize, inQualifierData)
	...
	switch(inAddress.mSelector)
	{
		case kAudioObjectPropertyBaseClass:
			...
			ThrowIf(inDataSize < sizeof(AudioClassID), CAException(kAudioHardwareBadPropertySizeError), "SV_Object::GetPropertyData: not enough space for the return value of kAudioObjectPropertyBaseClass");
		...
		case kAudioObjectPropertyClass:
			...
			ThrowIf(inDataSize < sizeof(AudioClassID), CAException(kAudioHardwareBadPropertySizeError), "SV_Object::GetPropertyData: not enough space for the return value of kAudioObjectPropertyClass");
		...
		case kAudioObjectPropertyOwner:
			...
			ThrowIf(inDataSize < sizeof(AudioObjectID), CAException(kAudioHardwareBadPropertySizeError), "SV_Object::GetPropertyData: not enough space for the return value of kAudioObjectPropertyOwner");
...
void	SV_Object::SetPropertyData(AudioObjectID inObjectID, pid_t inClientPID, const AudioObjectPropertyAddress& inAddress, UInt32 inQualifierDataSize, const void* inQualifierData, UInt32 inDataSize, const void* inData)
{
...
//==================================================================================================
#pragma mark -
#pragma mark SV_ObjectMap
//==================================================================================================

#pragma mark Construction/Destruction

SV_ObjectMap::SV_ObjectMap()
:
	mMutex("SV_ObjectMap Mutex"),
	mNextObjectID(32),
	mObjectInfoList()
{
...
void	SV_ObjectMap::StaticInitializer()
{
	sInstance = new SV_ObjectMap;
	AssertNotNULL(sInstance, "SV_ObjectMap::StaticInitializer: failed to create the object map");
}

#pragma mark External Methods

AudioObjectID	SV_ObjectMap::GetNextObjectID()
{
...
bool	SV_ObjectMap::MapObject(AudioObjectID inObjectID, SV_Object* inObject)
{
	pthread_once(&sStaticInitializer, StaticInitializer);
	bool theAnswer = false;
...
void	SV_ObjectMap::UnmapObject(AudioObjectID inObjectID, SV_Object* inObject)
{
	pthread_once(&sStaticInitializer, StaticInitializer);
	if((inObjectID != 0) && (inObject != NULL))
	{
...
SV_Object*	SV_ObjectMap::CopyObjectByObjectID(AudioObjectID inObjectID)
{
	pthread_once(&sStaticInitializer, StaticInitializer);
	SV_Object* theAnswer = NULL;
	if(inObjectID != 0)
	{
		CAMutex::Locker theLocker(sInstance->mMutex);
...
UInt64	SV_ObjectMap::RetainObject(SV_Object* inObject)
{
	pthread_once(&sStaticInitializer, StaticInitializer);
	UInt64 theAnswer = 0;
	if(inObject != NULL)
...
UInt64	SV_ObjectMap::ReleaseObject(SV_Object* inObject)
{
	pthread_once(&sStaticInitializer, StaticInitializer);
	UInt64 theAnswer = 0;
	if(inObject != NULL)
...
void	SV_ObjectMap::DestroyObject(SV_Object* inObject)
{
...
AudioObjectID	SV_ObjectMap::_GetNextObjectID()
{
	return mNextObjectID++;
}

bool	SV_ObjectMap::_MapObject(AudioObjectID inObjectID, SV_Object* inObject)
{
	bool theAnswer = false;
...
void	SV_ObjectMap::_UnmapObject(AudioObjectID inObjectID, SV_Object* inObject)
{
	//	we don't do mappings for IDs of 0 or NULL object pointers
	if((inObjectID != 0) && (inObject != NULL))
	{
...
SV_Object*	SV_ObjectMap::_CopyObjectByObjectID(AudioObjectID inObjectID)
{
	SV_Object* theAnswer = NULL;
	...
	if(theIterator != mObjectInfoList.end())
	{
		...
		{
			DebugMsg("SV_ObjectMap::_CopyObjectByObjectID: not copying because the reference count is at maximum");
		}
	}
...
UInt64	SV_ObjectMap::_RetainObject(SV_Object* inObject)
{
	UInt64 theAnswer = 0;
	...
	if(theIterator != mObjectInfoList.end())
	{
		...
		{
			DebugMsg("SV_ObjectMap::_RetainObject: not retaining because the reference count is at maximum");
		}
...
UInt64	SV_ObjectMap::_ReleaseObject(SV_Object* inObject)
{
	UInt64 theAnswer = 0;
	...
	if(theIterator != mObjectInfoList.end())
	{
		...
		{
			DebugMsg("SV_ObjectMap::_ReleaseObject: not releasing because the reference count is already at 0");
		}
...
pthread_once_t	SV_ObjectMap::sStaticInitializer = PTHREAD_ONCE_INIT;
SV_ObjectMap*	SV_ObjectMap::sInstance = NULL;
