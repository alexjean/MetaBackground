...
public:
								SV_Device(AudioObjectID inObjectID, io_object_t inIOObject);
...
private:
	...
	#define kDeviceUIDPattern	"SyncVoiceDevice-%d"
	#define kDeviceModelUID		"SyncVoiceDeviceModelUID"
	
	CAMutex						mStateMutex;
	CAMutex						mIOMutex;
	SV_IOKitObject				mIOKitObject;
	CACFString					mDeviceUID;
	UInt64						mStartCount;
	UInt64						mSampleRateShadow;
	UInt32						mRingBufferFrameSize;
	SyncVoiceDriverStatus*	mDriverStatus;
